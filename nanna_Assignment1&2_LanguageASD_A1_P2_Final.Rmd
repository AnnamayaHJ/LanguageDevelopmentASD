...
library(pacman)
p_load(lmerTest, pastecs, ggplot2, tidyverse, gdata, MuMIn, effects, corrplot, RColorBrewer)
#detach(package:plyr)
#library(dplyr)
...
#Note to self: cubic model runs, but there are convergence errors
```
...
#WE'VE CHANGED THE MODEL TO QUARDRATIC AFTER HANDING IN THE ASSIGNMENT BECAUSE OF CONVERGENCE
#WE'VE ALSO REMOVED ID AS A FIXED EFFECT BECAUSE IT'S A NO-GO TO HAVE IT TWICE
