...
```{r}
library(pacman)
p_load(gdata, pdflatex, TeX, stringr, tidyverse)
...
#Writing csv
write.csv(clean, "LanguageASD_final.csv")
...
#Nothing happens. It's still only included once.
...
#3: Some of the other variables might be relevant to the interpretation of language production - for example, if the MLU of the parent is also low, this might help determine some of the predisposistions of the individual child. All the demographic data is also relevant in the same sense. In general one would lose a lot of valuable information by only referring to the means, especially when it comes to interpreting and understanding observed differences.
